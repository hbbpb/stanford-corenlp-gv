...
public class StanfordCoreNLPServer implements Runnable {
     ...
     */
    public StanfordCoreNLPServer(int port, int timeout, boolean strict, Properties props) throws IOException {
        ...
        //support other language, add by neo.li@grapecity.com 2016-1-27
        if (props != null) {
            defaultProps = props;
        }
...
//            props.setProperty("annotators", annotators);
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (props.containsKey("coref.language")) {
            if (props.get("coref.language") != null && !"".equals(props.get("coref.language"))) {
                lanProps = props;
            }
        }
        ...
        // Run the server
        StanfordCoreNLPServer server = new StanfordCoreNLPServer(port, timeout, strict, lanProps);
        server.run();
    }
