...
echo java -mx4g -cp \"$scriptdir/libs/*\" edu.stanford.nlp.pipeline.StanfordCoreNLPServer -props StanfordCoreNLP-chinese.properties -outputFormat json
java -mx4g -cp "$scriptdir/libs/*" edu.stanford.nlp.pipeline.StanfordCoreNLPServer -props StanfordCoreNLP-chinese.properties -outputFormat json
